...
lista_fulbo = [10, 30, "Messi", 5, "Paredes"]
print(lista_fulbo[-2])
...
#Empieza creando una lista de numeros: [8, 15, 3, 22, 7]
numeros = [8, 15, 3, 22, 7] 

#Se usa numeros.remove para quitar el numero de la lista.
#Luego se usa max(numeros) para encontrar el numero mas grande de la lista, para despues quitarlo de la lista
numeros.remove(max(numeros)) 

#Finalmente se imprime por consola la lista sin el numero mas grande, [8, 15, 3, 7]
print(numeros)
...
#c)
quitar_pan = compras[0]
quitar_pan.remove("pan")
print(quitar_pan)
